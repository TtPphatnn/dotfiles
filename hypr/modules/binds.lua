...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("/home/PhatNguyen/.config/waybar/scripts/launch.sh"))

--screenshot tool by pewdiepie
hl.bind("Print", hl.dsp.exec_cmd("/home/PhatNguyen/.config/hypr/screenshottoolscript.sh"))
